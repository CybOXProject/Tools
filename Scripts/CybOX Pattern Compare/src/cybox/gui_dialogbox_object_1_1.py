...
class GUIDialogboxObjectType(gui_object.GUIObjectType):
    ...
    def __init__(self, Height=None, Width=None, Box_Caption=None, Box_Text=None):
    ...
    def export(self, outfile, level, namespace_='GUIDialogboxObj:', name_='GUIDialogboxObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='GUIDialogboxObj:', name_='GUIDialogboxObjectType', fromsubclass_=False):
        if self.Box_Caption is not None:
            self.Box_Caption.export(outfile, level, 'GUIDialogboxObj:', name_='Box_Caption')
        if self.Box_Text is not None:
            self.Box_Text.export(outfile, level, 'GUIDialogboxObj:', name_='Box_Text')
    def hasContent_(self):
        if (
            self.Box_Caption is not None or
            self.Box_Text is not None
            ):
            return True
        else:
            return False
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from GUI_Dialogbox_Object import *\n\n')
    sys.stdout.write('import GUI_Dialogbox_Object as model_\n\n')
