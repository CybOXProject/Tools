...
class NetworkSubnetObjectType(common.DefinedObjectType):
    ...
    def __init__(self, Name=None, Description=None, NumberOfIPAddresses=None, Routes=None, anytypeobjs_=None):
        super(NetworkSubnetObjectType, self).__init__(None)
        self.Name = Name
    ...
    def export(self, outfile, level, namespace_='NetworkSubnetObj:', name_='NetworkSubnetObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='NetworkSubnetObj:', name_='NetworkSubnetObjectType', fromsubclass_=False):
        if self.Name is not None:
            self.Name.export(outfile, level, 'NetworkSubnetObj:', name_='Name')
        if self.Description is not None:
            self.Description.export(outfile, level, 'NetworkSubnetObj:', name_='Description')
        if self.NumberOfIPAddresses is not None:
            self.NumberOfIPAddresses.export(outfile, level, 'NetworkSubnetObj:', name_='NumberOfIPAddresses')
        if self.Routes is not None:
            self.Routes.export(outfile, level, 'NetworkSubnetObj:', name_='Routes')
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.NumberOfIPAddresses is not None:
            showIndent(outfile, level)
            outfile.write('NumberOfIPAddresses=%s,\n' % quote_python(self.NumberOfIPAddresses).encode(ExternalEncoding))
        if self.Routes is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Name':
            ...
            NumberOfIPAddresses_ = child_.text
            NumberOfIPAddresses_ = self.gds_validate_string(NumberOfIPAddresses_, node, 'NumberOfIPAddresses')
            self.NumberOfIPAddresses = NumberOfIPAddresses_
...
class RoutesType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='NetworkSubnetObj:', name_='RoutesType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='NetworkSubnetObj:', name_='RoutesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='NetworkSubnetObj:', name_='RoutesType', fromsubclass_=False):
        for Route_ in self.Route:
            Route_.export(outfile, level, 'NetworkSubnetObj:', name_='Route')
    def hasContent_(self):
        if (
            self.Route
            ):
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Network_Subnet_Object import *\n\n')
    sys.stdout.write('import Network_Subnet_Object as model_\n\n')
