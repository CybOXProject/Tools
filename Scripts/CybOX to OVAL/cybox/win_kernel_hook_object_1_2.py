...
#
# Generated Tue Apr 10 13:54:56 2012 by generateDS.py version 2.7b.
#
...
class WindowsKernelHookObjectType(common.DefinedObjectType):
    ...
    def validate_KernelHookType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='WinKernelHookObj:', name_='WindowsKernelHookObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='WinKernelHookObj:', name_='WindowsKernelHookObjectType', fromsubclass_=False):
        if self.Digital_Signature_Hooking is not None:
            self.Digital_Signature_Hooking.export(outfile, level, 'WinKernelHookObj:', name_='Digital_Signature_Hooking')
        if self.Digital_Signature_Hooked is not None:
            self.Digital_Signature_Hooked.export(outfile, level, 'WinKernelHookObj:', name_='Digital_Signature_Hooked')
        if self.Hooking_Address is not None:
            self.Hooking_Address.export(outfile, level, 'WinKernelHookObj:', name_='Hooking_Address')
        if self.Hook_Description is not None:
            self.Hook_Description.export(outfile, level, 'WinKernelHookObj:', name_='Hook_Description')
        if self.Hooked_Function is not None:
            self.Hooked_Function.export(outfile, level, 'WinKernelHookObj:', name_='Hooked_Function')
        if self.Hooked_Module is not None:
            self.Hooked_Module.export(outfile, level, 'WinKernelHookObj:', name_='Hooked_Module')
        if self.Hooking_Module is not None:
            self.Hooking_Module.export(outfile, level, 'WinKernelHookObj:', name_='Hooking_Module')
        if self.Type is not None:
            self.Type.export(outfile, level, 'WinKernelHookObj:', name_='Type')
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Digital_Signature_Hooking is not None:
            showIndent(outfile, level)
            outfile.write('Digital_Signature_Hooking=%s,\n' % quote_python(self.Digital_Signature_Hooking).encode(ExternalEncoding))
        if self.Digital_Signature_Hooked is not None:
            showIndent(outfile, level)
            outfile.write('Digital_Signature_Hooked=%s,\n' % quote_python(self.Digital_Signature_Hooked).encode(ExternalEncoding))
        if self.Hooking_Address is not None:
            showIndent(outfile, level)
            outfile.write('Hooking_Address=%s,\n' % quote_python(self.Hooking_Address).encode(ExternalEncoding))
        if self.Hook_Description is not None:
            showIndent(outfile, level)
...
class KernelHookType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='WinKernelHookObj:', name_='KernelHookType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='WinKernelHookObj:', name_='KernelHookType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Win_Kernel_Hook_Object import *\n\n')
    sys.stdout.write('import Win_Kernel_Hook_Object as model_\n\n')
