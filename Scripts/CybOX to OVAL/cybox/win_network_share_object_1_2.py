...
class WindowsNetworkShareObjectType(common.DefinedObjectType):
    """he WindowsNetworkShareObjectType type is intended to characterize
    Windows network shares."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, ACCESS_PERM=None, ACCESS_ATRIB=None, ACCESS_ALL=None, ACCESS_READ=None, ACCESS_DELETE=None, ACCESS_WRITE=None, ACCESS_CREATE=None, ACCESS_EXEC=None, Current_Uses=None, Local_Path=None, Max_Uses=None, Netname=None, Type=None):
        super(WindowsNetworkShareObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='WinNetworkShareObj:', name_='WindowsNetworkShareObjectType', namespacedef_=''):
        showIndent(outfile, level)
        ...
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, 'WinNetworkShareObj:', name_)
            showIndent(outfile, level)
            outfile.write('</%s%s>\n' % (namespace_, name_))
        else:
            outfile.write('/>\n')
    ...
    def exportChildren(self, outfile, level, namespace_='WinNetworkShareObj:', name_='WindowsNetworkShareObjectType', fromsubclass_=False):
        if self.Current_Uses is not None:
            self.Current_Uses.export(outfile, level, namespace_, name_='Current_Uses')
        if self.Local_Path is not None:
            self.Local_Path.export(outfile, level, namespace_, name_='Local_Path')
        if self.Max_Uses is not None:
            self.Max_Uses.export(outfile, level, namespace_, name_='Max_Uses')
        if self.Netname is not None:
            self.Netname.export(outfile, level, namespace_, name_='Netname')
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Current_Uses is not None:
            showIndent(outfile, level)
            outfile.write('Current_Uses=%s,\n' % quote_python(self.Current_Uses).encode(ExternalEncoding))
        if self.Local_Path is not None:
            showIndent(outfile, level)
            outfile.write('Local_Path=%s,\n' % quote_python(self.Local_Path).encode(ExternalEncoding))
        if self.Max_Uses is not None:
            showIndent(outfile, level)
            outfile.write('Max_Uses=%s,\n' % quote_python(self.Max_Uses).encode(ExternalEncoding))
        if self.Netname is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Current_Uses':
            Current_Uses_ = child_.text
            Current_Uses_ = self.gds_validate_string(Current_Uses_, node, 'Current_Uses')
            self.Current_Uses = Current_Uses_
        elif nodeName_ == 'Local_Path':
            Local_Path_ = child_.text
            Local_Path_ = self.gds_validate_string(Local_Path_, node, 'Local_Path')
            self.Local_Path = Local_Path_
        elif nodeName_ == 'Max_Uses':
            Max_Uses_ = child_.text
            Max_Uses_ = self.gds_validate_string(Max_Uses_, node, 'Max_Uses')
            self.Max_Uses = Max_Uses_
...
class SharedResourceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='WinNetworkShareObj:', name_='SharedResourceType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='WinNetworkShareObj:', name_='SharedResourceType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Win_Network_Share_Object import *\n\n')
    sys.stdout.write('import Win_Network_Share_Object as model_\n\n')
