...
import semaphore_object_1_2 as semaphore_object
...
class WindowsSemaphoreObjectType(semaphore_object.SemaphoreObjectType):
    ...
    def __init__(self, named=None, Current_Count=None, Maximum_Count=None, Name=None, Handle=None, Security_Attributes=None):
        super(WindowsSemaphoreObjectType, self).__init__(named, Current_Count, Maximum_Count, Name)
        self.Handle = Handle
    ...
    def export(self, outfile, level, namespace_='WinSemaphoreObj:', name_='WindowsSemaphoreObjectType', namespacedef_=''):
        showIndent(outfile, level)
        ...
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, 'WinSemaphoreObj:', name_)
            showIndent(outfile, level)
            outfile.write('</%s%s>\n' % (namespace_, name_))
        else:
            outfile.write('/>\n')
    ...
    def exportChildren(self, outfile, level, namespace_='WinSemaphoreObj:', name_='WindowsSemaphoreObjectType', fromsubclass_=False):
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Win_Semaphore_Object import *\n\n')
    sys.stdout.write('import Win_Semaphore_Object as model_\n\n')
