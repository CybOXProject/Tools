...
class GUIObjectType(common.DefinedObjectType):
    ...
    def export(self, outfile, level, namespace_='GUIObj:', name_='GUIObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='GUIObj:', name_='GUIObjectType', fromsubclass_=False):
        if self.Height is not None:
            self.Height.export(outfile, level, 'GUIObj:', name_='Height')
        if self.Width is not None:
            self.Width.export(outfile, level, 'GUIObj:', name_='Width')
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from GUI_Object import *\n\n')
    sys.stdout.write('import GUI_Object as model_\n\n')
