...
class ImageInfoType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Command_Line is not None:
            showIndent(outfile, level)
            outfile.write('Command_Line=model_.cybox_common_types_v1_0.StringObjectAttributeType(\n')
            self.Command_Line.exportLiteral(outfile, level, name_='Command_Line')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Current_Directory is not None:
            showIndent(outfile, level)
            outfile.write('Current_Directory=model_.cybox_common_types_v1_0.StringObjectAttributeType(\n')
...
class ArgumentListType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Argument is not None:
            showIndent(outfile, level)
            outfile.write('Argument=model_.cybox_common_types_v1_0.StringObjectAttributeType(\n')
...
class ProcessObjectType(cybox_common_types_v1_0.DefinedObjectType):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Kernel_Time is not None:
            showIndent(outfile, level)
            outfile.write('Kernel_Time=model_.cybox_common_types_v1_0.DurationObjectAttributeType(\n')
        ...
        if self.User_Time is not None:
            showIndent(outfile, level)
            outfile.write('User_Time=model_.cybox_common_types_v1_0.DurationObjectAttributeType(\n')
