...
class FilePathType(cybox_common_types_1_0.StringObjectAttributeType):
    ...
    subclass = None
    superclass = None
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', trend=None, appears_random=None, regex_syntax=None, start_range=None, idref=None, id=None, condition=None, fully_qualified=None):
...
class PackerType(cybox_common_types_1_0.BaseObjectAttributeType):
...
class FileObjectType(cybox_common_types_1_0.DefinedObjectType):
    ...
    def validate_DateTimeObjectAttributeType(self, value):
        # Validate type cybox_common_types_1_0.DateTimeObjectAttributeType, a restriction on xs:dateTime.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Extracted_Features is not None:
            showIndent(outfile, level)
            outfile.write('Extracted_Features=model_.cybox_common_types_1_0.ExtractedFeaturesType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'File_Name':
            ...
            obj_ = cybox_common_types_1_0.ExtractedFeaturesType.factory()
            obj_.build(child_)
