...
defined_objects = {'AccountObjectType' : {'binding_name' : 'account_object_1_2', 'namespace_prefix' : 'AccountObj', 'namespace' : 'http://cybox.mitre.org/objects#AccountObject', 'schemalocation' : 'http://cybox.mitre.org/XMLSchema/objects/Account/Account_Object_1.2.xsd'},
                   ...
                   'GUIWindowObjectType' : {'binding_name' : 'gui_window_object_1_2', 'namespace_prefix' : 'GUIWindowOb', 'namespace' : 'http://cybox.mitre.org/objects#GUIWindowObject', 'schemalocation' : 'http://cybox.mitre.org/XMLSchema/objects/GUI_Window/GUI_Window_Object_1.2.xsd', 'dependencies' : 'GUIObject'},
                   ...
                   'WindowsProcessObjectType' : {'binding_name' : 'win_process_object_1_3', 'namespace_prefix' : 'WinProcessObj', 'namespace' : 'http://cybox.mitre.org/objects#WinProcessObject', 'schemalocation' : 'http://cybox.mitre.org/XMLSchema/objects/Win_Process/Win_Process_Object_1.3.xsd', 'dependencies' : 'WindowsHandleObjectType,MemoryObjectType,AddressObjectType,PortObjectType'},
