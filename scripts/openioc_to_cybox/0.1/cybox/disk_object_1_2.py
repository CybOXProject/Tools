...
#
# Generated Mon Apr 09 15:15:33 2012 by generateDS.py version 2.7b.
#
...
class DiskObjectType(common.DefinedObjectType):
    """The DiskObjectType type is intended to characterize disk drives."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, Disk_Name=None, Disk_Size=None, Free_Space=None, Partition_List=None, Type=None):
        super(DiskObjectType, self).__init__(None)
    ...
    def validate_DiskType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='DiskObj:', name_='DiskObjectType', namespacedef_=''):
        showIndent(outfile, level)
        ...
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, 'DiskObj:', name_)
            showIndent(outfile, level)
            outfile.write('</%s%s>\n' % (namespace_, name_))
        else:
            outfile.write('/>\n')
    ...
    def exportChildren(self, outfile, level, namespace_='DiskObj:', name_='DiskObjectType', fromsubclass_=False):
        if self.Disk_Name is not None:
            self.Disk_Name.export(outfile, level, namespace_, name_='Disk_Name')
        if self.Disk_Size is not None:
            self.Disk_Size.export(outfile, level, namespace_, name_='Disk_Size')
        if self.Free_Space is not None:
            self.Free_Space.export(outfile, level, namespace_, name_='Free_Space')
        if self.Partition_List is not None:
            self.Partition_List.export(outfile, level, namespace_, name_='Partition_List')
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Disk_Size is not None:
            showIndent(outfile, level)
            outfile.write('Disk_Size=%s,\n' % quote_python(self.Disk_Size).encode(ExternalEncoding))
        if self.Free_Space is not None:
            showIndent(outfile, level)
            outfile.write('Free_Space=%s,\n' % quote_python(self.Free_Space).encode(ExternalEncoding))
        if self.Partition_List is not None:
            showIndent(outfile, level)
...
class PartitionListType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='DiskObj:', name_='PartitionListType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='DiskObj:', name_='PartitionListType'):
        pass
    def exportChildren(self, outfile, level, namespace_='DiskObj:', name_='PartitionListType', fromsubclass_=False):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Partition_ in self.Partition:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(Partition_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
...
class DiskType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='DiskObj:', name_='DiskType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='DiskObj:', name_='DiskType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from disk_object import *\n\n')
    sys.stdout.write('import disk_object as model_\n\n')
