...
#
# Generated Mon Apr 09 15:15:17 2012 by generateDS.py version 2.7b.
#
...
class AccountObjectType(common.DefinedObjectType):
    ...
    def __init__(self, disabled=None, locked_out=None, Description=None, Domain=None):
        super(AccountObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='AccountObj:', name_='AccountObjectType', namespacedef_=''):
        showIndent(outfile, level)
        ...
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, 'AccountObj:', name_)
            showIndent(outfile, level)
            outfile.write('</%s%s>\n' % (namespace_, name_))
        else:
            outfile.write('/>\n')
    ...
    def exportChildren(self, outfile, level, namespace_='AccountObj:', name_='AccountObjectType', fromsubclass_=False):
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from account_object import *\n\n')
    sys.stdout.write('import account_object as model_\n\n')
