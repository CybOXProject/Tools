...
#
# Generated Thu Nov 01 09:42:19 2012 by generateDS.py version 2.7c.
#
...
class FilePathType(cybox_common_types_v1_0.StringObjectAttributeType):
...
class PackerType(cybox_common_types_v1_0.BaseObjectAttributeType):
    ...
    def __init__(self, end_range=None, pattern_type=None, has_changed=None, value_set=None, datatype='String', refanging_transform=None, refanging_transform_type=None, appears_random=None, trend=None, defanging_algorithm_ref=None, is_obfuscated=None, regex_syntax=None, obfuscation_algorithm_ref=None, start_range=None, idref=None, is_defanged=None, id=None, condition=None, valueOf_=None):
        super(PackerType, self).__init__(end_range, pattern_type, has_changed, value_set, datatype, refanging_transform, refanging_transform_type, appears_random, trend, defanging_algorithm_ref, is_obfuscated, regex_syntax, obfuscation_algorithm_ref, start_range, idref, is_defanged, id, condition, valueOf_, )
...
class FileObjectType(cybox_common_types_v1_0.DefinedObjectType):
    ...
    def validate_DoubleObjectAttributeType(self, value):
        # Validate type cybox_common_types_v1_0.DoubleObjectAttributeType, a restriction on None.
        pass
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Created_Time is not None:
            showIndent(outfile, level)
            outfile.write('Created_Time=model_.cybox_common_types_v1_0.DateTimeObjectAttributeType(\n')
        ...
        if self.Peak_Entropy is not None:
            showIndent(outfile, level)
            outfile.write('Peak_Entropy=model_.cybox_common_types_v1_0.DoubleObjectAttributeType(\n')
        ...
        if self.Extracted_Features is not None:
            showIndent(outfile, level)
            outfile.write('Extracted_Features=model_.cybox_common_types_v1_0.ExtractedFeaturesType(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'File_Name':
            ...
            obj_ = cybox_common_types_v1_0.DoubleObjectAttributeType.factory()
            obj_.build(child_)
            ...
            obj_ = cybox_common_types_v1_0.ExtractedFeaturesType.factory()
            obj_.build(child_)
