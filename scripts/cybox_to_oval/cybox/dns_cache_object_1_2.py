...
#
# Generated Tue Apr 10 13:54:49 2012 by generateDS.py version 2.7b.
#
...
class DNSCacheObjectType(common.DefinedObjectType):
    """The DNSCacheObjectType type is intended to characterize entries in a
    system's DNS cache."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, DNS_Cache_Entry=None):
        super(DNSCacheObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='DNSCacheObj:', name_='DNSCacheObjectType'):
        super(DNSCacheObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='DNSCacheObj')
    def exportChildren(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheObjectType', fromsubclass_=False):
        for DNS_Cache_Entry_ in self.DNS_Cache_Entry:
            DNS_Cache_Entry_.export(outfile, level, 'DNSCacheObj:', name_='DNS_Cache_Entry_')
...
class DNSCacheEntryType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheEntryType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='DNSCacheObj:', name_='DNSCacheEntryType'):
        pass
    def exportChildren(self, outfile, level, namespace_='DNSCacheObj:', name_='DNSCacheEntryType', fromsubclass_=False):
        if self.DNS_Entry is not None:
            self.DNS_Entry.export(outfile, level, 'DNSCacheObj:', name_='DNS_Entry')
        if self.TTL is not None:
            self.TTL.export(outfile, level, 'DNSCacheObj:', name_='TTL')
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.DNS_Entry is not None:
            showIndent(outfile, level)
            outfile.write('DNS_Entry=%s,\n' % quote_python(self.DNS_Entry).encode(ExternalEncoding))
        if self.TTL is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DNS_Entry':
            DNS_Entry_ = child_.text
            DNS_Entry_ = self.gds_validate_string(DNS_Entry_, node, 'DNS_Entry')
            self.DNS_Entry = DNS_Entry_
        elif nodeName_ == 'TTL':
            TTL_ = child_.text
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from DNS_Cache_Object import *\n\n')
    sys.stdout.write('import DNS_Cache_Object as model_\n\n')
