...
class LinuxPackageObjectType(common.DefinedObjectType):
    """The LinuxPackageObjectType type is intended to characterize Linux
    packages."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, Architecture=None, Category=None, Description=None, Epoch=None, EVR=None, Name=None, Release=None, Vendor=None, Version=None):
        super(LinuxPackageObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='LinuxPackageObj:', name_='LinuxPackageObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='LinuxPackageObj:', name_='LinuxPackageObjectType', fromsubclass_=False):
        if self.Architecture is not None:
            self.Architecture.export(outfile, level, 'LinuxPackageObj:', name_='Architecture')
        if self.Category is not None:
            self.Category.export(outfile, level, 'LinuxPackageObj:', name_='Category')
        if self.Description is not None:
            self.Description.export(outfile, level, 'LinuxPackageObj:', name_='Description')
        if self.Epoch is not None:
            self.Epoch.export(outfile, level, 'LinuxPackageObj:', name_='Epoch')
        if self.EVR is not None:
            self.EVR.export(outfile, level, 'LinuxPackageObj:', name_='EVR')
        if self.Name is not None:
            self.Name.export(outfile, level, 'LinuxPackageObj:', name_='Name')
        if self.Release is not None:
            self.Release.export(outfile, level, 'LinuxPackageObj:', name_='Release')
        if self.Vendor is not None:
            self.Vendor.export(outfile, level, 'LinuxPackageObj:', name_='Vendor')
        if self.Version is not None:
            self.Version.export(outfile, level, 'LinuxPackageObj:', name_='Version')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Architecture':
            ...
            self.validate_ArchitectureType(self.Architecture)    # validate type ArchitectureType
            ...
            Epoch_ = child_.text
            Epoch_ = self.gds_validate_string(Epoch_, node, 'Epoch')
            self.Epoch = Epoch_
        elif nodeName_ == 'EVR':
            EVR_ = child_.text
            EVR_ = self.gds_validate_string(EVR_, node, 'EVR')
            self.EVR = EVR_
        elif nodeName_ == 'Name':
            Name_ = child_.text
...
class ArchitectureType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='LinuxPackageObj:', name_='ArchitectureType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='LinuxPackageObj:', name_='ArchitectureType', fromsubclass_=False):
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Linux_Package_Object import *\n\n')
    sys.stdout.write('import Linux_Package_Object as model_\n\n')
