...
#
# Generated Tue Feb 07 14:29:54 2012 by generateDS.py version 2.7b.
#
...
from common_types_1_0 import PositiveIntegerObjectAttributeType as Port_Value
...
class PortObjectType(common.DefinedObjectType):
    """The PortObjectType type is intended to characterize networking
    ports."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, Port_Value=None, Layer4_Protocol=None):
        super(PortObjectType, self).__init__(None)
    ...
    def validate_Layer4ProtocolType(self, value):
        ...
        pass
    def export(self, outfile, level, namespace_='PortObj:', name_='PortObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='PortObj:', name_='PortObjectType'):
        ...
        pass
    def exportChildren(self, outfile, level, namespace_='PortObj:', name_='PortObjectType', fromsubclass_=False):
        super(PortObjectType, self).exportChildren(outfile, level, namespace_, name_, True)
        if self.Port_Value is not None:
            self.Port_Value.export(outfile, level, 'PortObj:', name_='Port_Value')
        if self.Layer4_Protocol is not None:
            self.Layer4_Protocol.export(outfile, level, 'PortObj:', name_='Layer4_Protocol')
    def hasContent_(self):
        if (
            self.Port_Value is not None or
            self.Layer4_Protocol is not None
            ):
            return True
        else:
            return False
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Port_Value is not None:
            showIndent(outfile, level)
            outfile.write('Port_Value=%s,\n' % quote_python(self.Port_Value).encode(ExternalEncoding))
        if self.Layer4_Protocol is not None:
            showIndent(outfile, level)
...
class Layer4ProtocolType(common.BaseObjectAttributeType):
    subclass = None
    superclass = common.BaseObjectAttributeType
    def __init__(self, patterntype=None, datatype='String', startRange=None, condition=None, regexsyntax=None, idref=None, id=None, endrange=None, valueset=None, valueOf_=None):
        super(Layer4ProtocolType, self).__init__(patterntype, datatype, startrange, condition, regexsyntax, idref, id, endrange, valueset, )
    ...
    def export(self, outfile, level, namespace_='PortObj:', name_='Layer4ProtocolType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportChildren(self, outfile, level, namespace_='PortObj:', name_='Layer4ProtocolType', fromsubclass_=False):
        super(Layer4ProtocolType, self).exportChildren(outfile, level, namespace_, name_, True)
        pass
    def hasContent_(self):
        if (
            self.valueOf_
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from port_object import *\n\n')
    sys.stdout.write('import port_object as model_\n\n')
