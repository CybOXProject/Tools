...
#
# Generated Mon Apr 16 13:27:27 2012 by generateDS.py version 2.7b.
#
...
class DeviceObjectType(common.DefinedObjectType):
    """The DeviceObjectType type is intended to characterize a specific
    Device."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, Description=None, Device_Type=None, Manufacturer=None, Model=None, Serial_Number=None):
        super(DeviceObjectType, self).__init__(named, Name)
    ...
    def export(self, outfile, level, namespace_='DeviceObj:', name_='DeviceObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='DeviceObj:', name_='DeviceObjectType', fromsubclass_=False):
        if self.Description is not None:
            self.Description.export(outfile, level, namespace_, name_='Description')
        if self.Device_Type is not None:
            self.Device_Type.export(outfile, level, namespace_, name_='Device_Type')
        if self.Manufacturer is not None:
            self.Manufacturer.export(outfile, level, namespace_, name_='Manufacturer')
        if self.Model is not None:
            self.Model.export(outfile, level, namespace_, name_='Model')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Description':
            ...
            Device_Type_ = child_.text
            Device_Type_ = self.gds_validate_string(Device_Type_, node, 'Device_Type')
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from device_object import *\n\n')
    sys.stdout.write('import device_object as model_\n\n')
