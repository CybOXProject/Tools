...
class ProductObjectType(common.DefinedObjectType):
    """The ProductObjectType type is intended to characterize software or
    hardware products."""
    subclass = None
    superclass = common.DefinedObjectType
    def __init__(self, Edition=None, Language=None, Product=None, Update=None, Vendor=None, Version=None):
        super(ProductObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='ProductObj:', name_='ProductObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='ProductObj:', name_='ProductObjectType', fromsubclass_=False):
        if self.Edition is not None:
            self.Edition.export(outfile, level, 'ProductObj:', name_='Edition')
        if self.Language is not None:
            self.Language.export(outfile, level, 'ProductObj:', name_='Language')
        if self.Product is not None:
            self.Product.export(outfile, level, 'ProductObj:', name_='Product')
        if self.Update is not None:
            self.Update.export(outfile, level, 'ProductObj:', name_='Update')
        if self.Vendor is not None:
            self.Vendor.export(outfile, level, 'ProductObj:', name_='Vendor')
        if self.Version is not None:
            self.Version.export(outfile, level, 'ProductObj:', name_='Version')
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Product_Object_Type import *\n\n')
    sys.stdout.write('import Product_Object_Type as model_\n\n')
