...
#
# Generated Tue Apr 10 13:54:52 2012 by generateDS.py version 2.7b.
#
...
import network_route_entry_object_1_0 as network_route_entry_object
...
class NetRouteObjectType(common.DefinedObjectType):
    ...
    def __init__(self, is_publish=None, is_autoconfigure_address=None, is_loopback=None, is_immortal=None, is_ipv6=None, Description=None, Network_Route_Entries=None, Preferred_Lifetime=None, Valid_Lifetime=None, Route_Age=None):
        super(NetRouteObjectType, self).__init__(None)
    ...
    def export(self, outfile, level, namespace_='NetworkRouteObj:', name_='NetRouteObjectType', namespacedef_=''):
        showIndent(outfile, level)
    ...
    def exportChildren(self, outfile, level, namespace_='NetworkRouteObj:', name_='NetRouteObjectType', fromsubclass_=False):
        if self.Description is not None:
            self.Description.export(outfile, level, 'NetworkRouteObj:', name_='Description')
        if self.Network_Route_Entries is not None:
            self.Network_Route_Entries.export(outfile, level, 'NetworkRouteObj:', name_='Network_Route_Entries')
        if self.Preferred_Lifetime is not None:
            self.Preferred_Lifetime.export(outfile, level, 'NetworkRouteObj:', name_='Preferred_Lifetime')
        if self.Valid_Lifetime is not None:
            self.Valid_Lifetime.export(outfile, level, 'NetworkRouteObj:', name_='Valid_Lifetime')
        if self.Route_Age is not None:
            self.Route_Age.export(outfile, level, 'NetworkRouteObj:', name_='Route_Age')
...
class NetworkRouteEntriesType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='NetworkRouteObj:', name_='NetworkRouteEntriesType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='NetworkRouteObj:', name_='NetworkRouteEntriesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='NetworkRouteObj:', name_='NetworkRouteEntriesType', fromsubclass_=False):
        for Network_Route_Entry_ in self.Network_Route_Entry:
            self.Network_Route_Entry_.export(outfile, level, 'NetworkRouteObj:', name_='Network_Route_Entry_')
    def hasContent_(self):
        if (
            self.Network_Route_Entry
            ):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Network_Route_Entry_ in self.Network_Route_Entry:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(Network_Route_Entry_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Network_Route_Entry':
            Network_Route_Entry_ = child_.text
            Network_Route_Entry_ = self.gds_validate_string(Network_Route_Entry_, node, 'Network_Route_Entry')
            self.Network_Route_Entry.append(Network_Route_Entry_)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from Network_Route_Object import *\n\n')
    sys.stdout.write('import Network_Route_Object as model_\n\n')
